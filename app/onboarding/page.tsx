...
export default function Onboarding() {
  ...
  return (
    <main className="flex min-h-dvh flex-col justify-center px-6">
      <p className="text-sm text-muted">{t("onboarding.first")}</p>
      <h1 className="mb-2 mt-1 font-display text-5xl italic leading-tight">{t("onboarding.name_q")}</h1>
      <p className="mb-8 text-muted">{t("onboarding.name_sub")}</p>
